...
GroundStation::GroundStation(ros::NodeHandle nh, std::string name){
    ...
    _ser_ang = nh.advertiseService("testbed/cmd/angle", &GroundStation::cmdAngleCallback,this);
    _ser_du  = nh.advertiseService("testbed/cmd/du"   , &GroundStation::cmdDuCallback   ,this);
...
void GroundStation::initializeParams(){
    ...
    ROS_INFO("Maximum and minimum values for angle command signals are set to:\n");
